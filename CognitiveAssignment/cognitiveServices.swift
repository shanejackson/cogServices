...
class CognitiveService {
    ...
    func test() {
        ...
        Alamofire.request(CognitiveService.apiUrl, method: .post, parameters: params, encoding: JSONEncoding.default, headers: header).responseJSON {
        
        
        //var results: [String:AnyObject]!
            (response) in
            var results = response.value as! [String : Any]! as [String : AnyObject]!
